...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText imgDescription,imgName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*txtDescription = imgDescription.getText().toString().trim();*/
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    MyModel myModel = new MyModel(imgName.getText().toString().trim(),
                                            imgDescription.getText().toString().trim(),
                                            uri.toString());

                                    //get id key from firebase
                                    String uploadID = mDatabaseRef.push().getKey();
                                    // set id to database
                                    mDatabaseRef.child(uploadID).setValue(myModel);
